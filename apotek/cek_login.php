<?php
	...
	$q1 = mysqli_query($con,"SELECT * FROM karyawan WHERE username='$username' AND password='$pass' AND blokir='N' AND id_ju = 'JU-07'");
	...
	if (!ctype_alnum($username) OR !ctype_alnum($pass)){
		...
		$login	= mysqli_query($con,"SELECT * FROM karyawan WHERE username='$username' AND password='$pass' AND blokir='N' AND id_ju = 'JU-07'");
