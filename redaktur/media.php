  ...
  <?php include 'header.php'; ?>
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <a href="?module=home" class="brand-link">
        <img src="<?php echo $url2; ?>dist/img/AdminLTELogo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
          style="opacity: .8">
        <span class="brand-text font-weight-light">Klinik CGS</span>
      </a>
      ...
      <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
          ...
          <?php } ?>
            ...
            <!-- <img src="<?php echo $url2; ?>dist/img/user2-160x160.jpg" class="img-circle elevation-2" alt="User Image"> -->
          </div>
          <div class="info">
          ...
          while($data_menu  = mysqli_fetch_array($menu)){
            ...
            <li class="nav-item">
              <a href="?module=<?php echo $data_menu['page_sm']; ?>" class="nav-link">
                ...
                ?>
                <p title="<?php echo $rujuk; ?> pasien dirujuk inap">
                  <?php echo $rujuk; ?>
                </p>
              <?php } ?>
              </a>
