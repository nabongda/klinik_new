...
?>
	...
	<table width="100%" class="table1">
        ...
        <tbody>
        <tr>
			<td><?php echo tgl_indo($data['tgl_rontgen']); ?></td>
			<td><div align="right"><a target="_blank" href="../report_det/rpt_det_ron.php?id=<?php echo $data['tgl_rontgen']; ?>"><?php echo $data['jumlah']; ?></a></div></td>
		</tr>
        <?php
			}
		?>
