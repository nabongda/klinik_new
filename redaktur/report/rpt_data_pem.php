...
?>
	...
	<table width="100%" class="table1">
        ...
        <?php
			$pem	= mysqli_query($con, "SELECT tgl_periksa, count(id_antrian) as jumlah From pemeriksaan_pasien Where tgl_periksa Between '$tgl1' And '$tgl2' Group by tgl_periksa");
