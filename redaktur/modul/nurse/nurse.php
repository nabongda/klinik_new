        ...
        <div class="card-header">
          <div>
            ...
            <button type="button" class="btn btn-secondary" data-toggle="modal"
              data-target="#modal-default2">Tukar Jadwal</button>
          </div>
        </div>
        <div class="card-body">
              ...
              <div class="modal-dialog modal-xs" role="document">
                <div class="modal-content">
                  ...
                  <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary pull-left" id="tukarin" onclick="switched()">Simpan</button>
                  </div>
                </div>
              </div>
            </div>
            <!-- Modals Tukar Jadwal -->
            <div class="modal fade" id="modal-default2" tabindex="-1" role="dialog" aria-hidden="true">
              <div class="modal-dialog modal-xs" role="document">
                <div class="modal-content">
                  <div class="modal-header">
                    <h5 class="modal-title">Jadwal Perawat </h5>
                  ...
                  <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal">Batal</button>
                    <button type="button" class="btn btn-primary pull-left" id="tukarin" onclick="switched2()">Simpan</button>
                  </div>
                </div>
              </div>
            </div>
