    ...
    <div class="row">
      <div class="col-md-12">
        <div class="card">
		  ...
		  <div class="card-body">
			<h5>Keterangan Pemeriksaan Pasien</h5><hr>
			<form enctype="multipart/form-data" id="form_pc" method="POST" action="modul/pemeriksaan/pc_selesai.php">
				<div class="col-md-12">
		  ...
		  <div class="card-body">
			<h5>History Pemeriksaan Pasien</h5><hr>
			<div class="col-md-12">
...
<script>
	...
	$(document).ready(function(){
		$(".foto").attr("src","modul/pemeriksaan/dummy.png");
		$.ajaxSetup({
			headers: {
		...
		$('#tabel_tp').dataTable( {
			...
			"bProcessing": true,
			"bServerSide": true,
			"sAjaxSource": "modul/pemeriksaan/data_tp.php?nofak="+nofak,
		...
		$('#form_px').on('submit', function (e) {
			...
			$.ajax({
				type: 'post',
				url: 'modul/pemeriksaan/tambah_t.php?kat=' + $("#tataup2").val(),
		...
		$('#form_produk').on('submit', function (e) {
			...
			$.ajax({
				type: 'post',
				url: 'modul/pemeriksaan/tambah_p.php',
		...
		$('body').on("click","#plus_p",function(){
			...
			$.ajax({
				type:'POST',
				url: 'modul/pemeriksaan/plus.php',
				data:{
					id:id
				},
				success:function(data){
     	...
     	$('body').on("click","#hapus_p",function(){
			...
			$.ajax({
				type:'POST',
				url: 'modul/pemeriksaan/hapus.php',
				data:{
					id:id
				},
				success:function(data){
		...
		$('body').on("click","#minus_p",function(){
			...
			$.ajax({
				type:'POST',
				url: 'modul/pemeriksaan/minus.php',
				data:{
					id:id
				},
				success:function(data){
		...
		$('body').on("click","#reset_t",function(){
			...
			$.ajax({
				type:'POST',
				url: 'modul/pemeriksaan/reset.php',
				data:{
					id:id
				},
				success:function(data){
