...
// } else {
$byr = mysqli_fetch_assoc(mysqli_query($con,"SELECT SUM(sub_total) jml FROM kasir_sementara WHERE no_faktur = '$_GET[faktur]' AND id IN ($_GET[data])"));
// }
...
function simpan(){
	window.open("modul/rawat_jalan/print.php?faktur=<?php echo $_GET['faktur']; ?>&uang=" + $("#bayar").val() + "&data=<?php echo urlencode($_GET['data']); ?>&layan=<?php echo $_GET['layan']; ?>&pasien=<?php echo $id_pasien; ?>","_BLANK");
}
