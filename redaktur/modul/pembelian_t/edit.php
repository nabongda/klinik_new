...
?>
<form role="form" method="POSt" enctype="multipart/form-data" action="modul/pembelian_t/edit_transaksi.php">
  <div class="modal-body">
    <?php $tampil     = mysqli_query($con,"SELECT * FROM beli WHERE id = $id");
