...
function UploadImage($fupload_name){
  //direktori gambar
  $vdir_upload = "../../../file_user/foto_berita/";
...
function UploadAgenda($fupload_name){
  //direktori gambar
  $vdir_upload = "../../../file_user/foto_agenda/";
  $vfile_upload = $vdir_upload . $fupload_name;
  $imageType = $_FILES["fupload"]["type"];
...
function Uploadpasangiklan($fupload_name){
  //direktori Logo
  $vdir_upload = "../../../file_user/foto_pasangiklan/";
  $vfile_upload = $vdir_upload . $fupload_name;
  $imageType = $_FILES["fupload"]["type"];
...
function Uploadiklantengah($fupload_name){
  //direktori Logo
  $vdir_upload = "../../../file_user/foto_iklantengah/";
   $vfile_upload = $vdir_upload . $fupload_name;
  $imageType = $_FILES["fupload"]["type"];
...
function Uploadiklanatas($fupload_name){
  //direktori Logo
  $vdir_upload = "../../../file_user/foto_iklanatas/";
  $vfile_upload = $vdir_upload . $fupload_name;
...
function UploadBackground($fupload_name){
  ...
  $vdir_upload = "../../../file_user/img_background/";
  $vfile_upload = $vdir_upload . $fupload_name;
  $tipe_file   = $_FILES['fupload']['type'];
...
function UploadBanner($fupload_name){
  //direktori banner
  $vdir_upload = "../../../file_user/foto_banner/";
  $vfile_upload = $vdir_upload . $fupload_name;
...
function UploadAlbum($fupload_name){
  //direktori gambar
  $vdir_upload = "../../../file_user/img_album/";
$vfile_upload = $vdir_upload . $fupload_name;
  $imageType = $_FILES["fupload"]["type"];
...
function UploadGallery($fupload_name){
  //direktori gambar
  $vdir_upload = "../../../file_user/img_galeri/";
  $vfile_upload = $vdir_upload . $fupload_name;
  $imageType = $_FILES["fupload"]["type"];
...
function UploadPlaylist($fupload_name){
  //direktori gambar
  $vdir_upload = "../../../file_user/img_playlist/";
   $vfile_upload = $vdir_upload . $fupload_name;
  $imageType = $_FILES["fupload"]["type"];
...
function UploadVideo($fupload_name){
  //direktori gambar
  $vdir_upload = "../../../file_user/img_video/";
  $vfile_upload = $vdir_upload . $fupload_name;
  $imageType = $_FILES["fupload"]["type"];
...
function UploadStatis($fupload_name){
  //direktori gambar
  $vdir_upload = "../../../file_user/foto_statis/";
  $vfile_upload = $vdir_upload . $fupload_name;
  $imageType = $_FILES["fupload"]["type"];
...
function UploadUser($fupload_name){
  //direktori gambar
  $vdir_upload = "../../../file_user/foto_user/";
  $vfile_upload = $vdir_upload . $fupload_name;
  $imageType = $_FILES["fupload"]["type"];
...
// IDENTITAS//////////////////////////////////////////////////////
function UploadIdentitas($fupload_name){
  //direktori gambar
  $vdir_upload = "../../../file_user/foto_identitas/";
  $vfile_upload = $vdir_upload . $fupload_name;
  $imageType = $_FILES["fupload"]["type"];
